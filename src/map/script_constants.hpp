...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(IG_SQUADPRIZE);
	export_constant(IG_ODINRELIC);
	export_constant(IG_SPEIMEN);
	export_constant(IG_MATERIAL);
	export_constant(IG_DELIVERY);
	export_constant(IG_MEMOBOX);
	export_constant(IG_MEMOBOX1);
	export_constant(IG_MEMOBOX2);
	export_constant(IG_MEMOBOX3);
	export_constant(IG_MEMOBOX4);
	export_constant(IG_MEMOBOX5);
	export_constant(IG_MEMOBOX6);
	export_constant(IG_MEMOBOX7);
	export_constant(IG_MEMOBOX8);
	export_constant(IG_MEMOBOX9);
	export_constant(IG_MEMOBOX10);
	export_constant(IG_MEMOBOX11);
	export_constant(IG_MEMOBOX12);
	...
	export_constant(EF_AMDARAIS_EFFECT);
